...
DEFAULT_THR      = float(os.environ.get("DEFAULT_THR",      "0.5"))
MMS_FALLBACK_THR = float(os.environ.get("MMS_FALLBACK_THR", "0.111145"))
...
def pick_threshold(filename_stem: str) -> Tuple[float, str]:
    ...
    """
    if FORCE_MMS:
        return MMS_CAL_THR, "mms_calibrated" if CALIB_JSON.exists() else "mms_fallback"
